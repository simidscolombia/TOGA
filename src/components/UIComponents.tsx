...
import { Lock, X, CheckCircle2, AlertCircle, Info, Sparkles, Lightbulb, Send, Minimize2, Mic, MicOff } from 'lucide-react';
...
export const ToastNotification: React.FC<ToastProps> = ({ id, type, message, onClose }) => {
  ...
  return (
    <div className={`flex items-center gap-3 px-4 py-3 rounded-xl shadow-lg border ${bgColors[type]} animate-slide-in-from-right duration-300 max-w-sm w-full mb-3`}>
      {icons[type]}
...
// --- Wompi Widget Component ---
export const WompiWidget: React.FC = () => {
  useEffect(() => {
...
export const Modal: React.FC<{ isOpen: boolean; onClose: () => void; title: string; children: React.ReactNode }> = ({ isOpen, onClose, title, children }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden animate-zoom-in">
